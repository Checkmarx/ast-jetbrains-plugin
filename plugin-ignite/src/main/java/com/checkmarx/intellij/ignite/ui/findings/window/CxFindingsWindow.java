package com.checkmarx.intellij.ignite.ui.findings.window;

import com.checkmarx.intellij.common.devassist.ignore.IgnoreManager;
...
import com.checkmarx.intellij.common.devassist.problems.ProblemHolderService;
import com.checkmarx.intellij.common.devassist.remediation.RemediationManager;
import com.checkmarx.intellij.common.devassist.telemetry.TelemetryService;
import com.checkmarx.intellij.common.devassist.ui.actions.VulnerabilityFilterBaseAction;
import com.checkmarx.intellij.common.devassist.ui.actions.VulnerabilityFilterState;
import com.checkmarx.intellij.common.devassist.ui.findings.window.CxIgnoredFindings;
import com.checkmarx.intellij.common.devassist.ui.findings.window.IssueTreeRenderer;
...
public class CxFindingsWindow extends SimpleToolWindowPanel implements Disposable {
    ...
    private static final Logger LOGGER = Utils.getLogger(com.checkmarx.intellij.common.devassist.ui.findings.window.CxFindingsWindow.class);
