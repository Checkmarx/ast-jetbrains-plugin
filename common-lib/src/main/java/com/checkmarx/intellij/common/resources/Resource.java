...
public enum Resource {
    ...
    FINDINGS_PROMO_LINK,
    DEVASSIST_DOC_LINK,
    IGNITE_PLUGIN_SETTINGS_TITLE,
    IGNITE_PLUGIN_SETTINGS_CHILD_TITLE,
    IGNITE_PLUGIN_SETTINGS_HELP_LINK_LABEL,
    IGNITE_PLUGIN_SETTINGS_AUTH_SECTION,
    IGNITE_PLUGIN_SETTINGS_SIGN_IN_BUTTON,
    IGNITE_PLUGIN_AUTH_SUCCESS_MSG,
    IGNITE_PLUGIN_REALTIME_SCANNERS_OSS_TITLE,
    IGNITE_PLUGIN_REALTIME_SCANNERS_SECRETS_TITLE,
    IGNITE_PLUGIN_REALTIME_SCANNERS_CONTAINERS_TITLE,
    IGNITE_PLUGIN_REALTIME_SCANNERS_IAC_TITLE,
    IGNITE_PLUGIN_REALTIME_SCANNERS_ASCA_TITLE,
    IGNITE_PLUGIN_REALTIME_SCANNERS_IAC_PREFIX,
    IGNITE_PLUGIN_WELCOME_TITLE,
    IGNITE_PLUGIN_WELCOME_SUBTITLE,
    IGNITE_PLUGIN_WELCOME_CHECK_TITLE
}