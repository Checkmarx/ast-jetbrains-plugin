...
public class BranchSelectionGroup extends BaseSelectionGroup {
    ...
    private class OnBranchChange implements BranchChangeListener {
        ...
        /**
         * {@inheritDoc}
         * Log the event and ignore it, we should only change AST branch when the branch change is confirmed.
         */
        @Override
        ...
        /**
         * {@inheritDoc}
         * Trigger a branch change in AST if the selected branch matches an available AST branch for the current project.
         */
        @Override
