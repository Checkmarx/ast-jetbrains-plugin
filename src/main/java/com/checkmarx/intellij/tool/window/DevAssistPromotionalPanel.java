...
public class DevAssistPromotionalPanel extends JPanel {
    ...
    private void buildUI() {
        // Promotional image
        Icon scannerIcon = CxIcons.getWelcomeScannerIcon();
        JBLabel imageLabel = new JBLabel(scannerIcon);
        imageLabel.setHorizontalAlignment(SwingConstants.CENTER);
        add(imageLabel, "growx, gapbottom 20");
        ...
        JBLabel descriptionLabel = new JBLabel("<html><div style='text-align: center; width: 350px;'>" 
