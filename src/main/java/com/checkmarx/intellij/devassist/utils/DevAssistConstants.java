...
public final class DevAssistConstants {
    ...
    public static final String FIX_WITH_AI = "Fix with AI";
    public static final String FIX_WITH_COPILOT = "Fix with Copilot";
    public static final String FIX_WITH_AUGMENT = "Fix with Augment";
