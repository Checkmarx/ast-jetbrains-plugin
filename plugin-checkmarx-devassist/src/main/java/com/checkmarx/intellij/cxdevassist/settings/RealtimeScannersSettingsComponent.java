...
public class RealtimeScannersSettingsComponent implements SettingsComponent, Disposable {
    ...
    private final JBLabel ascaTitle = new JBLabel(formatTitle(Bundle.message(Resource.DEVASSIST_PLUGIN_REALTIME_SCANNERS_ASCA_TITLE)));
    ...
    private final JBLabel ossTitle = new JBLabel(formatTitle(Bundle.message(Resource.DEVASSIST_PLUGIN_REALTIME_SCANNERS_OSS_TITLE)));
    private final JBCheckBox ossCheckbox = new JBCheckBox(Bundle.message(Resource.OSS_REALTIME_CHECKBOX));

    private final JBLabel secretsTitle = new JBLabel(formatTitle(Bundle.message(Resource.DEVASSIST_PLUGIN_REALTIME_SCANNERS_SECRETS_TITLE)));
    private final JBCheckBox secretsCheckbox = new JBCheckBox(Bundle.message(Resource.SECRETS_REALTIME_CHECKBOX));

    private final JBLabel containersTitle = new JBLabel(formatTitle(Bundle.message(Resource.DEVASSIST_PLUGIN_REALTIME_SCANNERS_CONTAINERS_TITLE)));
    private final JBCheckBox containersCheckbox = new JBCheckBox(Bundle.message(Resource.CONTAINERS_REALTIME_CHECKBOX));

    private final JBLabel iacTitle = new JBLabel(formatTitle(Bundle.message(Resource.DEVASSIST_PLUGIN_REALTIME_SCANNERS_IAC_TITLE)));
    ...
    public RealtimeScannersSettingsComponent() {
        ...
        connection.subscribe(SettingsListener.SETTINGS_APPLIED, (SettingsListener) () -> SwingUtilities.invokeLater(() -> {
    ...
    private void buildUI() {
        ...
        JBLabel containersLabel = new JBLabel(formatTitle(Bundle.message(Resource.DEVASSIST_PLUGIN_REALTIME_SCANNERS_IAC_PREFIX)));
