package com.checkmarx.intellij.ast.commands.results;
...
public class Results {
    ...
    private static final Logger LOGGER = Utils.getLogger(com.checkmarx.intellij.common.commands.results.Results.class);
