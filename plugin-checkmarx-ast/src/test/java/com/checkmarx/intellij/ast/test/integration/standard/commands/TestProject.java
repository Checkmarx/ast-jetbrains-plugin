...
public class TestProject extends BaseTest {
    ...
    public void testGetList() {
        ...
        List<Project> projects
                = Assertions.assertDoesNotThrow(com.checkmarx.intellij.ast.commands.Project::getList);
    ...
    public void testGetBranches_WithNotSCMProject_shouldIgnoreLocalBranchValue() {
        Project project = getEnvProject();
        List<String> branches = Assertions.assertDoesNotThrow(() -> com.checkmarx.intellij.ast.commands.Project.getBranches(
