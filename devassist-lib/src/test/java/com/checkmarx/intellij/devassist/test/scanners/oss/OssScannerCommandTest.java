package com.checkmarx.intellij.devassist.test.scanners.oss;
...
public class OssScannerCommandTest {
    ...
    private static class TestOssScannerCommand extends OssScannerCommand {
        ...
        @Override
        protected VirtualFile findVirtualFile(String path) { return null; } // avoid LocalFileSystem.getInstance()
